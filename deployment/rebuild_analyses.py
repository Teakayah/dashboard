...
def _inject_insight(html: str, insight: str) -> tuple[str, bool]:
    ...
    pattern = r"""
        <!--\ insight-inject\ -->   # Matches the opening injection marker
        .*?                         # Non-greedily matches existing content between markers
        <!--\ /insight-inject\ -->  # Matches the closing injection marker
    """
