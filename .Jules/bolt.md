...
## 2024-05-30 - [Optimize Grid.js Object Mapping]
**Learning:** When initializing `gridjs.Grid` with large datasets, mapping an array of plain objects into an array of arrays creates significant CPU and memory overhead. Grid.js has native object mapping if columns define `id` attributes matching object keys.
