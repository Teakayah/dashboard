...
## 2026-07-10 - Structured Empty States for Data Grids
**Learning:** Plain text "No results" in data grids provides poor visual hierarchy and confuses screen readers.
**Action:** Always replace plain text with visually structured HTML that includes an explicitly hidden decorative icon (`aria-hidden="true"`), a bold heading, and a helpful description of next steps.
