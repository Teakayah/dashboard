...
## 2026-07-11 - Structured empty states for data grids
**Learning:** Plain text like "No results" lacks visual hierarchy and can be confusing for screen readers or users expecting a data table.
