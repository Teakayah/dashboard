...
## 2026-07-16 - Empty States Need Visual Structure
**Learning:** Displaying plain text like "No results" for an empty data grid state feels broken to users and lacks visual hierarchy.
**Action:** When designing empty states for data grids, always replace plain text with visually structured HTML that includes an explicitly hidden decorative icon (`aria-hidden="true"`), a bold heading, and a helpful description of what happened.
