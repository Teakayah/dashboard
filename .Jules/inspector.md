...
**Learning:** Hardcoded timeouts (`page.wait_for_timeout`) make tests slow and flaky.
**Action:** Replace them with auto-waiting assertions like `expect().not_to_have_text()` to ensure tests wait only as long as needed.
