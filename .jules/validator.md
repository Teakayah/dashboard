...
## 2026-05-18 - [Robust marker extraction]
Coverage Gap: [A test verified HTML marker removal using a hardcoded version string, which failed when the internal marker version was incremented in the code.]
Learning: [Tests testing internal configurations via hardcoded constants are fragile and easily broken by routine updates.]
Assertion: [Dynamically extract internal configuration constants in the test directly from the module under test.]
