...
function renderResults(rows) {
    if (rows.length === 0) {
        document.getElementById('results').innerHTML = '<div style="padding: 3rem 1rem; text-align: center; color: var(--text-muted);"><svg aria-hidden="true" style="margin: 0 auto 1rem; width: 48px; height: 48px; opacity: 0.5;" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path></svg><h3 style="font-size: 1.125rem; font-weight: 600; margin-bottom: 0.5rem; color: var(--text);">No results found</h3><p style="font-size: 0.875rem;">Your query executed successfully, but returned 0 rows. Try adjusting your SQL filters or uploading different data.</p></div>';
        return;
    }
