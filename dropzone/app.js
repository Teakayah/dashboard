...
/**
 * Escapes a string to safely use it as an identifier (like a table or column name) in SQL queries.
 * Double quotes within the identifier are escaped by doubling them up ("").
 *
