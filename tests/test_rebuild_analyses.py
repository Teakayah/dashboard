import pytest
from deployment.rebuild_analyses import extract_emp_rate
...
def test_extract_emp_rate_basic():
    rows = [
        ...
        create_row(geo="Ontario", ref_date="2023-02", value="61.0"), # Average for 2023 should be 60.5
