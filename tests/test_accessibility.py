...
PENDING_RULES = {
    'color-contrast',               # Deferred: underlying CSS/UI issues need to be fixed by Palette persona
...
def test_dropzone_status_has_live_region(page: Page):
    ...
    page.goto(f'{BASE}/dropzone.html', wait_until='domcontentloaded', timeout=60000)
    live = page.evaluate(
